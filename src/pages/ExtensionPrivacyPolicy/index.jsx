    ...
    <GS.Container>
      <div className="privacy-policy-container">
        <div className="tab-content translations-content-item en visible" id="en">
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                Spotter Labs Inc, 7501 Lemont Rd Suite 305, Woodridge IL 60517.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Load Companion, accessible from{' '}
                <a href="extension.spotter.ai" rel="external nofollow noopener" target="_blank">
                  extension.spotter.ai
                </a>
              </p>
            </li>
            <li>
          ...
          <h3>Emailing on user&apos;s behalf</h3>
          <p>
            Our privacy policy regarding the use of the &quot;gmail.send&quot; scope for sending
            emails from a user&apos;s account is as follows:{' '}
          </p>

          <p>
            We will only request access to this scope when necessary for the functionality of our
            app. We will not send any emails without the explicit action of the user. We will not
            store or share any user&apos;s email address or other personal information without their
            explicit consent. We will not use any emails sent through our app for any marketing or
            advertising purposes. We will not share any data collected through the use of this scope
            with any third parties. Users have the right to revoke our access to this scope at any
            time through their Google Account settings. By using our app, users consent to the
            collection and use of their information as described in this privacy policy.
          </p>
          ...
          <ul>
            <li>By email: extension_support@spotter.ai</li>
          </ul>
          <br />
          <br />
        </div>
