...
<p style="text-align:center; margin: 20px 0;">
  <img src="${MarketMomentumSlows}" alt="Blog Image Placeholder" style="max-width: 100%; height: auto; border-radius: 8px;" />
</p>
...
<p style="text-align:center; margin: 20px 0;">
  <img src="${Class8TruckOrders}" alt="Chart Placeholder" style="max-width: 100%; height: auto; border-radius: 8px;" />
</p>
...
<p style="text-align:center; margin: 20px 0;">
  <img src="${Graph}" alt="Chart Placeholder" style="max-width: 100%; height: auto; border-radius: 8px;" />
</p>
...
<p style="text-align:center; margin: 20px 0;">
  <img src="${bl3img1}" alt="Ocean Shipping Chart" style="max-width: 100%; height: auto; border-radius: 8px;" />
</p>
...
<p style="text-align:center; margin: 0px 0; display: flex; flex-direction: row; gap: 10px; width: 50%">
  <img src="${bl3img2}" alt="Gateway Diversification Chart" style="max-width: 100%; height: auto; border-radius: 8px;" />
  <img src="${bl3img3}" alt="Gateway Diversification Chart 2" style="max-width: 100%; height: auto; border-radius: 8px; margin-top: 10px;" />
</p>
...
<p style="text-align:center; margin: 0px 0; display: flex; flex-direction: row; gap: 10px; width: 50%">
  <img src="${bl3img4}" alt="Truck Orders Chart" style="max-width: 100%; height: auto; border-radius: 8px;" />
  <img src="${bl3img5}" alt="Truck Sales Chart" style="max-width: 100%; height: auto; border-radius: 8px; margin-top: 10px;" />
</p>
...
<p style="text-align:center; margin: 20px 0;">
  <img src="${bl3img6}" alt="Freight Rate Chart" style="max-width: 100%; height: auto; border-radius: 8px;" />
</p>
...
<p style="text-align:center; margin: 20px 0;">
  <img src="${bl3img7}" alt="VOTRI Chart" style="max-width: 100%; height: auto; border-radius: 8px;" />
</p>
...
<p style="text-align:center; margin: 20px 0;">
  <img src="${bl3img8}" alt="Mode Share Chart" style="max-width: 100%; height: auto; border-radius: 8px;" />
</p>
...
<p style="text-align:center; margin: 20px 0;">
  <img src="${bl4img1}" alt="Flatbed Market Chart" style="max-width: 100%; height: auto; border-radius: 8px;" />
</p>
...
<p style="text-align:center; margin: 20px 0;">
  <img src="${bl4img2}" alt="Flatbed Performance Chart" style="max-width: 100%; height: auto; border-radius: 8px;" />
</p>
<ul>
<li>Shippers are:</li>
...
<p style="text-align:center; margin: 20px 0;">
  <img src="${bl4img3}" alt="Manufacturing PMI Chart" style="max-width: 100%; height: auto; border-radius: 8px;" />
</p>
...
<p style="text-align:center; margin: 20px 0;">
  <img src="${bl4img4}" alt="Export Orders Chart" style="max-width: 100%; height: auto; border-radius: 8px;" />
</p>
...
<p style="text-align:center; margin: 20px 0;">
  <img src="${bl4img5}" alt="Import Index Chart" style="max-width: 100%; height: auto; border-radius: 8px;" />
</p>
